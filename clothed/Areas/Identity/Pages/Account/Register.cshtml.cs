    ...
    public class RegisterModel : PageModel
    {
        ...
        <body style='font-family: Arial, sans-serif; background-color: #000000; color: #fff; padding: 20px;'>
            <div style='max-width: 600px; margin: 0 auto; padding: 20px; background-color: rgba(0, 0, 0, 0.8); border-radius: 8px; text-align: center;'>
                ...
                <p style='font-size: 16px; color: #ff69b4;'>Thank you for registering with us. To complete your registration, please confirm your email address by clicking the button below:</p>
                ...
                <p style='font-size: 14px; color: #bbb; margin-top: 20px;'>If you did not create an account, no further action is required.</p>
